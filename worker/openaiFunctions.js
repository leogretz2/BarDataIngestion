...
import { insertMBEQuestion, insertMEEQuestion, insertMPTQuestion, end_document_processing } from "./supabaseFunctions.js";
  ...
  const tools = [
    ...
    function: {
      ...
      parameters: {
        ...
        required: ["Document_title", "Doc_Lines_to_Delete", "Document_Date", "question_type", "question", "answers", "correct_answer", "answer_origin", "explanation", "explanation_origin", "difficulty_level", "law_category_tags", "topic" ],
      },
    },
    },
    {
...
2. Record and list the line numbers of the lines that you copied your content from on the source document to send as Doc_Lines_to_Delete.
...
6. Question type can be 'MBE', 'MEE', or 'MPT'. All multiple choice questions are type MBE.
7. If there is no clear data on the document date or publisher, put 'NA'.
...
13: When there are no more questions in the document, call the end_document_processing tool with the boolean true. 
...
export async function handleResponse(tool_calls, filePath) {
